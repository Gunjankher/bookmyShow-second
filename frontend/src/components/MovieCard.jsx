...
function MovieCard({
  ...
  return (
    <>
   <div
    className='w-[232px] bg-slate-900 rounded-lg overflow-hidden shadow-lg h-[381px] text-white'
   ...
   >
    ...
    <div className='h-[300px] overflow-hidden'>
        <img style={{width :'100%', height:'110%', objectFit:"cover"}} src={poster} alt="" />
    </div>
         ...
         <div className='pt-2'>
            ...
            <div className='pt-2 flex justify-between w-full itmes-center text-[15px] font-light'>
                <p className=''>{genre}</p>
                <p className='mr-6'>{formats}</p>
            </div>
         </div>
