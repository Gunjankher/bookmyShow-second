...
import { MdPayments, MdRecommend } from 'react-icons/md';
...
function AdminNavbar() {
    ...
    const profileImg = useSelector((state) => state.admin.adminData?.avatar);
    ...
    return (
        ...
        <>
            <nav className="w-full bg-white flex justify-between items-center p-4 sm:gap-5 gap-2 border-b-2 border-gray-500 sticky top-0 z-50">
