...
function Signup() {
    ...
    return (
        <div className='w-full h-screen text-black p-3 flex justify-center items-start sm:mt:8 shadow-2xs'>
                    ...
                    <div className='w-full relative h-28 bg-[#222222]'>
                        <div className='w-full h-full'>
                            <GetImagePreview
                                name="coverImage"
                                control={control}
                                className="w-full h-28 object-cover border-none border-black bg-white text-black"
                                cameraIcon
                            />
